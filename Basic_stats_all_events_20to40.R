...
##EVENTS: "T3MCDW", "T6MCDW", "PIRAFLG", "RAWFLG", "T3MRAW", "T6MRAW", "T3MPIRA", "T6MPIRA"
...
DAY1_20to40_USUBJID <- DAY1_df$USUBJID[which(DAY1_df$AGE >= 20 & DAY1_df$AGE < 40)]

DAY1_20to40_df <- df[df$USUBJID %in% DAY1_20to40_USUBJID, ]
...
write.csv(summary_table, "/data/users/rty388/testing/Freq_summary_for_all_events_DAY1_20to40.csv", row.names = FALSE)
